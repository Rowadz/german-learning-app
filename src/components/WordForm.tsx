    ...
    <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
      ...
      <div className="form-control w-full">
        ...
        <input
          ...
          className={`input input-bordered input-sm sm:input-md w-full ${errors.noun ? "input-error" : ""}`}
          value={formData.noun}
          onChange={handleChange}
        />
        {errors.noun && (
      ...
      <div className="form-control w-full">
        <label className="label">
          <span className="label-text text-sm sm:text-base">Phrase *</span>
        </label>
        <input
          type="text"
          name="phrase"
          placeholder="e.g., die Tür aufschließen"
          className={`input input-bordered input-sm sm:input-md w-full ${errors.phrase ? "input-error" : ""}`}
      ...
      <div className="form-control w-full">
        ...
        <textarea
          ...
          className={`textarea textarea-bordered textarea-sm sm:textarea-md w-full ${errors.example ? "textarea-error" : ""}`}
      ...
      <div className="form-control w-full">
        ...
        <textarea
          ...
          className={`textarea textarea-bordered textarea-sm sm:textarea-md w-full ${errors.translation ? "textarea-error" : ""}`}
      ...
      <div className="form-control w-full">
        ...
        <label className="label">
          <span className="label-text-alt text-xs">
            Optional: Add tags to help organize entries
          </span>
        </label>
      </div>

      {/* Buttons */}
      <div className="flex gap-2 justify-end pt-2 sm:pt-4 flex-wrap">
        {onCancel && (
          <button
            type="button"
