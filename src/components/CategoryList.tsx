...
function CategoryCard({ categoryId }: CategoryCardProps) {
  ...
  return (
    <Link
      ...
      className="card bg-base-200 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1 active:scale-95"
    >
      <div className="card-body p-4 sm:p-6">
        ...
        {/* Stats */}
        <div className="grid grid-cols-3 gap-1.5 sm:gap-2 mt-3 sm:mt-4 text-center">
        ...
        <div className="flex justify-between mt-3 text-xs">
          <span className="badge badge-sm badge-neutral">
            {progressCounts.new} new
          </span>
          <span className="badge badge-sm badge-warning">
            {progressCounts.learning} learning
          </span>
          <span className="badge badge-sm badge-success">
            {progressCounts.known} known
          </span>
        </div>
      </div>
    </Link>
